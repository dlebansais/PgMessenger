# What is PgMessenger?
PgMessenger is a Windows program (download [here](https://github.com/dlebansais/PgMessenger/releases/download/v1.0.0.16/PgMessenger.zip)) that let you read the game chat of *Project: Gorgon* on any computer.
...
2. [Download](https://github.com/dlebansais/PgMessenger/releases/download/v1.0.0.16/PgMessenger.zip) and extract PgMessenger.zip somewhere on your computer.
...
If you just want to read in-game chat, [download](https://github.com/dlebansais/PgMessenger/releases/download/v1.0.0.16/PgMessenger.zip) and extract PgMessenger.zip, then run PgMessenger.exe.
